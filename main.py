...
class AnyaPet(QMainWindow):
    def __init__(self):
        ...
        self.anim_sprites = {
            ...
            "walk_forward": [get_asset_path(f"sprites/walk_forward/{i}.jpg") for i in range(2)],   # спиною до нас (вгору)
            "walk_backward": [get_asset_path(f"sprites/walk_backward/{i}.jpg") for i in range(2)]  # обличчям до нас (вниз)
        }
